...
# graph for the sampling means?
# sampling mean distributiont is a normal distribution!

# This kind of distribution is called
# sampling mean distribution.
# And provided we take sufficient number of samples,
# the sampling mean distribution for ANY kind of data
# will always be a normal distribution!

# Let's find the mean of the sampling distribution.
